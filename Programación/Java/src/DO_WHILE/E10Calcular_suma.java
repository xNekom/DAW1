...
public class E10Calcular_suma {
    public static void main(String[] args) {
        ...
        System.out.println("Debes calcular cuál es el resultado de la suma de los siguientes números:"); // Indica al usuario que debe calcular la suma de dos números aleatorios

        do { // Inicia un bucle do-while
            int num1 = (int)((Math.random() * 100) + 1); // Genera un número aleatorio entre 1 y 100 y lo guarda en la variable num1
            int num2 = (int)((Math.random() * 100) + 1); // Genera otro número aleatorio entre 1 y 100 y lo guarda en la variable num2
            resultado = num1 + num2; // Calcula la suma de los dos números aleatorios y lo guarda en la variable resultado
            ...
            if (intento == resultado) { // Verifica si la solución es correcta
                System.out.println("¡Correcto! Prueba de nuevo"); // Imprime un mensaje de felicitación si la solución es correcta
                contador++; // Incrementa el contador de operaciones correctas
            }
            else {
                System.out.println("Fallaste, ¡mejor suerte la próxima vez!"); // Imprime un mensaje de error si la solución es incorrecta
            }
        }
        while (intento == resultado); // Continúa el bucle do-while mientras la solución sea correcta
        System.out.println("Número total de operaciones correctas: " + contador); // Imprime el número total de operaciones correctas
    }
}
