...
public class E1Un_segundo_más {
	...
	public static void main(String[] args) {
		...
		// Hay que anidar una consecución de ifs para poder establecer todas las
		// condiciones sin que una
		// pise a otra.
		if ((hora >= 0) && (hora <= 23)) {
			if ((minuto >= 0) && (minuto <= 59)) {
				if ((segundo >= 0) && (segundo <= 59)) {
					...
					// Para que los números del rango 1-9 nos den 2 dígitos (Ej: 01, 02, 03) debemos
					// crear nuevas
